...
EVENT_GROUP_ALIASES: dict[str, list[str]] = {
    ...
    # NBA
    "nba_champ": ["NBA Finals", "NBA Champion", "KXNBACHAMP", "KXNBA"],
    ...
    "nba_roy": ["NBA Rookie", "Rookie of the Year", "KXNBAROY"],
    "nba_coy": ["NBA Coach", "Coach of the Year", "KXNBACOY"],
    "nba_sixth": ["Sixth Man", "KXNBASIXTH"],
    "nba_mip": ["Most Improved", "KXNBAMIMP"],
    "nba_playoff": ["NBA Playoff Qualifier", "KXNBAPLAYOFF"],
    "nba_draft1": ["NBA Draft", "#1 overall pick", "KXNBADRAFT1"],
    # MLB
    "mlb_ws": ["World Series", "KXMLBWS", "KXMLB"],
    "mlb_al": ["AL Champion", "American League Champion", "KXMLBALCHAMP", "KXMLBAL"],
    "mlb_nl": ["NL Champion", "National League Champion", "KXMLBNLCHAMP", "KXMLBNL"],
    "mlb_playoff": ["MLB Playoff Qualifier", "KXMLBPLAYOFFS"],
    # NHL
    "nhl_champ": ["Stanley Cup", "NHL Champion", "KXNHLCHAMP", "KXNHL"],
    "nhl_east": ["NHL Eastern", "Eastern Conference Finals", "KXNHLEAST"],
    "nhl_west": ["NHL Western", "Western Conference Finals", "KXNHLWEST"],
    "nhl_playoff": ["NHL Playoff Qualifier", "Stanley Cup Playoff", "KXNHLPLAYOFF"],
    # Soccer
    "ucl_champ": ["Champions League", "KXUCLCHAMP", "KXUCL"],
    "epl_champ": ["Premier League", "EPL", "KXEPLCHAMP"],
    "epl_top4": ["EPL Top 4", "Premier League Top 4", "KXEPLTOP4"],
    "epl_top2": ["EPL Top 2", "Premier League Top 2", "KXEPLTOP2"],
    "laliga_champ": ["La Liga", "KXLALIGACHAMP", "KXLALIGA"],
    "bundesliga_champ": ["Bundesliga", "KXBUNDESLIGACHAMP", "KXBUNDESLIGA"],
    "seriea_champ": ["Serie A", "KXSERIEACHAMP", "KXSERIEA"],
    "ligue1_champ": ["Ligue 1", "KXLIGUE1CHAMP", "KXLIGUE1"],
    ...
    # Tennis
    "atp_grandslam": ["ATP Grand Slam", "KXATPGRANDSLAM"],
    "wta_grandslam": ["WTA Grand Slam", "KXWTAGRANDSLAM"],
    # Golf
    ...
    "f1_constructors": ["F1 Constructor", "Constructors Champion", "KXF1CONSTRUCTORS"],
    # Additional soccer
